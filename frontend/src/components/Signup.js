        ...
        <Container className='mt-3' style={{ width: '70%' }}>
            <Form onSubmit={ handleSubmit }>
                ...
                <Form.Group className='mb-3'>
                    ...
                    <Form.Control type='text' id='name' name='name' onChange={ onChange } aria-describedby='emailHelp' minLength={ 3 } autoComplete='off' required />
                </Form.Group>
                <Form.Group className='mb-3'>
                    <Form.Label>Email address</Form.Label>
                    <Form.Control type='email' id='email' name='email' onChange={ onChange } aria-describedby='emailHelp' autoComplete='off' required />
                ...
                <Button type='submit' variant='primary'
                    disabled={ credentials.password.length < 8 || credentials.cpassword.length < 8 }>Submit</Button>
            </Form>
        </Container>
    );
};
